...
public class JenaTDBDataSourceTest extends DataSourceTest<RDFNode, String, String> {
   ...
   */
  @Override
  protected TriplePatternElementParser<RDFNode, String, String> getTriplePatternElementParser() {
  ...
  public static void setUpClass() throws Exception {
    ...
    if (!DataSourceTypesRegistry.isRegistered(typeName)) {
      DataSourceTypesRegistry.register(typeName, new JenaTDBDataSourceType());
    }
    ...
    JsonObject config = createConfig("jena tdb test", "jena tdb test", typeName);
