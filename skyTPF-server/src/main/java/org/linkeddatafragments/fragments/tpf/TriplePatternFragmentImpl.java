...
public class TriplePatternFragmentImpl extends TriplePatternFragmentBase {
   ...
   * @param datasetURL
   */
  public TriplePatternFragmentImpl(final String fragmentURL, final String datasetURL) {
   ...
   * @param pageNumber
   */
  public TriplePatternFragmentImpl(final Model triples, long totalSize, final String fragmentURL,
