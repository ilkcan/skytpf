...
/**
   *
   */
public abstract class FragmentRequestParserWorkerBase {
   ...
   * @param config
   */
  public FragmentRequestParserWorkerBase(final HttpServletRequest request,
      final ConfigReader config) {
    this.request = request;
    this.config = config;

    final String givenPageNumber =
        request.getParameter(ILinkedDataFragmentRequest.PARAMETERNAME_PAGE);
  ...
  public static String extractBaseURL(final HttpServletRequest request, final ConfigReader config) {
