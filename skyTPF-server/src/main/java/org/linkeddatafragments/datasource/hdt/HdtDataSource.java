...
import org.linkeddatafragments.skytpf.SkyTPFRequestParserForJenaBackends;
...
public class HdtDataSource extends DataSourceBase {
   ...
   * 
   */
  protected final HdtRequestProcessor requestProcessor;
  ...
  public HdtDataSource(String title, String description, String hdtFile)
    ...
    requestProcessor = new HdtRequestProcessor(hdtFile);
  }

  @Override
  public IFragmentRequestParser getRequestParser() {
    return SkyTPFRequestParserForJenaBackends.getInstance();
  }
