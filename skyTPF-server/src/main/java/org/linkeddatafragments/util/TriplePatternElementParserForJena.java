...
public class TriplePatternElementParserForJena
   ...
   */
  @Override
  public RDFNode createTypedLiteral(final String label, final String typeURI) {
    final RDFDatatype dt = TypeMapper.getInstance().getSafeTypeByName(typeURI);
   ...
   */
  @Override
  public RDFNode createLanguageLiteral(final String label, final String languageTag) {
