...
/**
 * Parses strings (as obtained from HTTP request parameters) into {@link ITriplePatternElement}s.
 *
 ...
 */
abstract public class TriplePatternElementParser<ConstantTermType, NamedVarType, AnonVarType>
  ...
  public final TriplePatternElementFactory<ConstantTermType, NamedVarType, AnonVarType> factory =
      new TriplePatternElementFactory<ConstantTermType, NamedVarType, AnonVarType>();
   ...
   * @return
   */
  public ITriplePatternElement<ConstantTermType, NamedVarType, AnonVarType> parseIntoTriplePatternElement(
      final String param) {
