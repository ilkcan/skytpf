...
abstract public class RDFTermParser<TermType> {
   ...
   * @return
   */
  abstract public TermType createTypedLiteral(final String label, final String typeURI);
   ...
   * @return
   */
  abstract public TermType createLanguageLiteral(final String label, final String langTag);
