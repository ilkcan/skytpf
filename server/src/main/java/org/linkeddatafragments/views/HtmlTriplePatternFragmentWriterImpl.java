...
// TODO: Refactor to a composable & flexible architecture using DataSource types, fragments types
// and request types
...
public class HtmlTriplePatternFragmentWriterImpl extends TriplePatternFragmentWriterBase
  ...
  public void writeFragment(ServletOutputStream outputStream, IDataSource datasource,
      ITriplePatternFragment fragment, ITriplePatternFragmentRequest tpfRequest)
    ...
    data.put("end", start + (triples.size() < fragment.getMaxPageSize() ? triples.size()
