...
/**
 * <p>
 * Use this class to run as a standalone service. Since it runs the BasicLdfServlet, it is important
 * to have a configuration file in the web.xml as "configFile" init parameter. Default
 * [baseDir]/config.xml
 * </p>
 * <p>
 * This class runs an embedded Jetty servlet container. This way there is no need for a separate
...
public class JettyServer {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // The use of server.join() the will make the current thread join and wait until the server is
    // done executing.
