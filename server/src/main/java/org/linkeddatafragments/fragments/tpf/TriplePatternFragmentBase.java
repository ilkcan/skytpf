...
abstract public class TriplePatternFragmentBase extends LinkedDataFragmentBase
   ...
   * @param datasetURL
   */
  public TriplePatternFragmentBase(final String fragmentURL, final String datasetURL) {
   ...
   * @param isLastPage
   */
  public TriplePatternFragmentBase(long totalSize, final String fragmentURL,
      final String datasetURL, final long pageNumber, final boolean isLastPage) {
  ...
  public void addMetadata(final Model model) {
    ...
    final Literal totalTyped = model.createTypedLiteral(totalSize, XSDDatatype.XSDinteger);
    final Literal limitTyped = model.createTypedLiteral(getMaxPageSize(), XSDDatatype.XSDinteger);
  ...
  public String getTemplate() {
    return datasetURL + "{?" + ITriplePatternFragmentRequest.PARAMETERNAME_SUBJ + ","
        + ITriplePatternFragmentRequest.PARAMETERNAME_PRED + ","
        + ITriplePatternFragmentRequest.PARAMETERNAME_OBJ + "}";
  }
