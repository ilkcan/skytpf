...
public class TriplePatternElementFactory<CTT, NVT, AVT> {
   ...
   * @return
   */
  public ITriplePatternElement<CTT, NVT, AVT> createAnonymousVariable(final AVT bnode) {
   ...
   * @return
   */
  public ITriplePatternElement<CTT, NVT, AVT> createConstantRDFTerm(final CTT term) {
   ...
   * @param <AVT>
   */
  static public class UnspecifiedVariable<CTT, NVT, AVT> extends Variable<CTT, NVT, AVT> {
    @Override
   ...
   * @param <AVT>
   */
  static abstract public class SpecificVariable<CTT, NVT, AVT> extends Variable<CTT, NVT, AVT> {
    @Override
    public boolean isSpecificVariable() {
      return true;
    }
   ...
   * @param <AVT>
   */
  static public class NamedVariable<CTT, NVT, AVT> extends SpecificVariable<CTT, NVT, AVT> {
   ...
   * @param <AVT>
   */
  static public class AnonymousVariable<CTT, NVT, AVT> extends SpecificVariable<CTT, NVT, AVT> {
