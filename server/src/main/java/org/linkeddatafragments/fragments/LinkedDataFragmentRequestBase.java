...
public abstract class LinkedDataFragmentRequestBase implements ILinkedDataFragmentRequest {
   ...
   * @param pageNumber
   */
  public LinkedDataFragmentRequestBase(final String fragmentURL, final String datasetURL,
  ...
  public String toString() {
    return "LinkedDataFragmentRequest(" + "class: " + getClass().getName() + ", fragmentURL: "
        + fragmentURL + ", isPageRequest: " + pageNumberWasRequested + ", pageNumber: " + pageNumber
        + ")";
  }
