...
public interface IFragmentRequestParser {
  /**
   * Parses the given HTTP request into a specific {@link ILinkedDataFragmentRequest}.
   *
   ...
   */
  ILinkedDataFragmentRequest parseIntoFragmentRequest(final HttpServletRequest httpRequest,
